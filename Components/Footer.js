...
function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".08" className='w-full flex gap-10 h-screen font-["Founders_Grotesk_X_Condensed"]   '>
      <div className="text-[8vw] h-screen flex flex-col justify-between w-1/2 uppercase  p-20 font-bold leading-none tracking-tight">
        <div>
          <h1>eye-</h1>
          <h1>opening</h1>
        </div>
        ...
        <div className="w-1/2 p-20 ">
            <h1 className="text-[8vw] font-semibold uppercase leading-none tracking-tight">presentations</h1>

        <div className="text-[2vw]  leading-none  capitalize mt-10">
        ...
        <div className="text-[2vw]  leading-none   mt-10">
            <h1>E:</h1>
